...
SECRET_KEY = 'django-insecure-^$fvvsrs#kb3nnn4$=a5#0nla9p8va+bonwn6$ai8eby%520%5'
...
ACCOUNT_SUGNUP_EMAIL_ENTER_TWICE = True
...
STRIPE_WH_SECERT = os.getenv('STRIPE_WH_SECERT', '')
